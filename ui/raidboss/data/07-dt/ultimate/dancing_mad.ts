...
const getPathOfLightPlayersForGroup = (
  ...
  return players.filter((player) => data.pathOfLightAssignmentByPlayer[player]?.group === group);
};
...
const triggerSet: TriggerSet<Data> = {
  ...
  config: [
    ...
    },
    {
      ...
      comment: {
        en:
          'Xinde: suggest your marker by T/D/H priority, then refresh from your actual sign marker at first Black Hole',
